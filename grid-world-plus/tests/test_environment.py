...
import grid_world_plus.rlm_env.environment
...
Array = np.ndarray
Env = rlm_env.Env
PathMaker = grid_world_plus.rlm_env.environment.PathMaker
...
def init_env() -> Tuple[Env, PathMaker]:
    ...
    env: Env = rlm_env.Env(grid_shape=(15,15), n_goals=4, 
                                  hole_pct = 0.3)
    pm: PathMaker = grid_world_plus.rlm_env.environment.PathMaker(env)
    return env, pm
