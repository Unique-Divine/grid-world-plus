...
import dataclasses
import os, sys 
<<<<<<< HEAD:rl-algos/rl_algos/algos/dqn.py
import grid_world_plus as rlm
import grid_world_plus.tools
from grid_world_plus.rlm_env import environment, representations, memory
from grid_world_plus.rl_algos import base, trackers
=======
...
>>>>>>> main:rl-algos/rl_algos/algos/dqn_algo.py
...
class DQNAlgo(base.RLAlgorithm): # TODO Write the DQN class and change this algo
    ...
    def update_q_network(self):
        ...
        scene_disc_rewards: Array = grid_world_plus.tools.discount_rewards(
