...
from grid_world_plus.rl_algos import base
from grid_world_plus.rl_algos import trackers
...
class VPGPolicyNN(nn.Module):
    ...
    def __init__(self, obs_size: torch.Size, action_dim: int, 
        ...
        self.memory = grid_world_plus.memory.Memory()
